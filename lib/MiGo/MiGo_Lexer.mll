...
rule read = parse
    ...
    | "<"        { (* Format.fprintf fmt "LANGB ";             *)  LANGB }
    | ">"        { (* Format.fprintf fmt "RANGB ";             *)  RANGB }
    | "+"        { (* Format.fprintf fmt "PLUS ";             *)   PLUS }
    ...
    | "ifFor"    { (* Format.fprintf fmt "IFFOR ";              *) IFFOR }
    | "then"     { (* Format.fprintf fmt "IFFOR ";              *) THEN }
